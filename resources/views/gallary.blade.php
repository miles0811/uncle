		...
		<div id="portfolio-content" class="center-text">
			<div class="portfolio-page" id="page-1">
				<div class="portfolio-group">
					<a class="portfolio-item" href="img/1-large.jpg">
						<img src="img/1-small.jpg" alt="image 1">
						<div class="detail">
							<h3>Wavy Road</h3>
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="img/2-large.jpg">
						<img src="img/2-small.jpg" alt="image 2">
						<div class="detail">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="img/3-large.jpg">
						<img src="img/3-small.jpg" alt="image 3">
						<div class="detail">
							<h3>Clear River</h3>
							<p>Duis ac laoreet mi. Maecenas non lorem sed elit molestie tincidunt. Vestibulum tincidunt libero urna, ut dignissim purus accumsan nec.</p>
							<span class="btn">View</span>
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="img/4-large.jpg">
						<img src="img/4-small.jpg" alt="image 4">
						<div class="detail">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="img/5-large.jpg">
						<img src="img/5-small.jpg" alt="image 5">
						<div class="detail">
							<h3>Bustling City</h3>
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="img/6-large.jpg">
						<img src="img/6-small.jpg" alt="image 6">
						<div class="detail">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="img/7-large.jpg">
						<img src="img/7-small.jpg" alt="image 7">
						<div class="detail">
							<h3>Clean Design</h3>
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="img/8-large.jpg">
						<img src="img/8-small.jpg" alt="image 8">
						<div class="detail">
							<h3>Rock Solid</h3>
			...
			<div class="portfolio-page" id="page-3" style="display:none;">
				...
				<div class="portfolio-group">
					<a class="portfolio-item" href="img/6-large.jpg">
						<img src="img/6-small.jpg" alt="image 22">
						<div class="detail">
							<h3>Retired Leaves</h3>
							<p>Sed in molestie lectus. Curabitur non est neque. Maecenas id luctus ligula. Mauris dignissim ante eu arcu ultricies, at sodales orci aliquet.</p>
							<span class="btn">View</span>
